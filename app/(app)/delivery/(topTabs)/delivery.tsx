...
const UserOrders = () => {
   ...
   const { data, isLoading, error, refetch, isFetching, isPending, isFetched } = useQuery({
    ...
    select: (data) => data.filter(item => item.order.order_type === 'package'),
    ...
    if (isLoading || isFetching || isPending || !isFetched || !data) return <LoadingIndicator/>
                ...
                >
                    ...
                    >
                        ...
                        <StatCard
                            ...
                            color={"green"}
                        />
                      { user?.user_type !== 'rider' || user?.user_type!=='dispatch' && <StatCard
                                                  icon={ClockIcon}
                                                  label="Pending"
                                                  value={stats.pending}
                                                  color={"orange"}
