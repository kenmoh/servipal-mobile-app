    ...
    return (
        ...
        >
            ...
            <view className="gap-6 items-center mt-10" >
                <Text
                    className="text-primary text-[28px] font-poppins-bold"

                >
                    {isSuccess ? "Payment Successful!" : "Payment Failed"}
                </Text>
                <Text
                    className="text-gray-400 text-sm font-poppins text-center px-6 leading-6"
            ...
            <View className="flex-row gap-4 mt-5 items-center" >
                {isSuccess && (
                    <TouchableOpacity onPressIn={() => {
                        ...
                        <View
                            className="border p-4 h-[120px] w-[120px] elevation-sm bg-input shadow-sm shadow-gray-400 shadow-opacity-20 rounded-md items-center justify-center"


                        >
                            <Download color={'orange'} size={35} />
                            <Text
                                className="text-primary text-xs font-poppins-medium text-center mt-2"
